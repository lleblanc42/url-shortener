...
<body>
    <div id="app">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        <li class="nav-item">
                            <a class="nav-link" href="/">{{ __('Shorten') }}</a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link" href="/top">{{ __('Top 100') }}</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <footer>
            <p>Built with <i class="fas fa-heart"></i> <i class="far fa-copyright"></i> {{ date('Y') }} Luke LeBlanc</p>
        </footer>
    </div>
